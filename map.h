...
typedef const void* const constMapDataElement;

/** Key element data type for map container */
typedef void* MapKeyElement;
typedef const void* const constMapKeyElement;
...
*/
bool mapContains(Map map, constMapKeyElement element);
...
*/
MapResult mapPut(Map map, constMapKeyElement keyElement, constMapDataElement dataElement);
...
*/
MapDataElement mapGet(Map map, constMapKeyElement keyElement);
...
*/
MapResult mapRemove(Map map, constMapKeyElement keyElement);
